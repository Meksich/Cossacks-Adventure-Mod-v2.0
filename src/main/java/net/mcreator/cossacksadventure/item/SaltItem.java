...
public class SaltItem extends CossacksAdventureModElements.ModElement {
	@ObjectHolder("cossacks_adventure:salt")
	public static final Item block = null;
	public SaltItem(CossacksAdventureModElements instance) {
		super(instance, 2);
	}
