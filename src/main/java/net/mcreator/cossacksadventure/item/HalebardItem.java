...
import net.mcreator.cossacksadventure.procedures.ProjectileHalebardTickProcedure;
...
public class HalebardItem extends CossacksAdventureModElements.ModElement {
	@ObjectHolder("cossacks_adventure:halebard")
	public static final Item block = null;
	@ObjectHolder("cossacks_adventure:entitybullethalebard")
	public static final EntityType arrow = null;
	public HalebardItem(CossacksAdventureModElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullethalebard").setRegistryName("entitybullethalebard"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void tick() {
			...
			Entity entity = this.getShooter();
			{
				...
				ProjectileHalebardTickProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				this.remove();
			}
