...
public class CosacksBowItem extends CossacksAdventureModElements.ModElement {
	@ObjectHolder("cossacks_adventure:cosacks_bow")
	public static final Item block = null;
	@ObjectHolder("cossacks_adventure:entitybulletcosacks_bow")
	public static final EntityType arrow = null;
	public CosacksBowItem(CossacksAdventureModElements instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletcosacks_bow").setRegistryName("entitybulletcosacks_bow"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.3f, 3.9999999999999996, 3);
